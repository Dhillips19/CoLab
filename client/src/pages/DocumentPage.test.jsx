...
jest.mock('../components/Editor/Editor', () => () => <div data-testid="mock-editor">Editor Component</div>);
jest.mock('../components/Editor/Chat', () => () => <div data-testid="mock-chat">Chat Component</div>);
jest.mock('../components/Editor/UserList', () => ({ users }) => <div data-testid="mock-userlist">{users?.length || 0} users</div>);
jest.mock('../components/Editor/DocumentTitle', () => () => <div data-testid="mock-title">Document Title</div>);
jest.mock('../components/Editor/Export', () => () => <div data-testid="mock-export">Export Options</div>);
jest.mock('../components/Editor/ManageCollaborators', () => () => <div data-testid="mock-collaborators">Manage Collaborators</div>);
...
describe('DocumentPage Component', () => {
  ...
  beforeEach(() => {
    ...
    // Mock successful document verification by default
